...
export const CampaignForm: React.FC<CampaignFormProps> = ({ initialData, isEdit }) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 max-w-3xl bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
